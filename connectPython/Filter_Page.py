...
df = pd.read_excel(
    'C:/Users/Pratik Kumar/Desktop/python/filter dash/Book2.xlsx')
df.drop(df[df['Transaction Type'] == 'Deposit'].index, inplace=True)
df.reset_index(drop=True, inplace=True)
df_trade = pd.read_excel(
    'C:/Users/Pratik Kumar/Desktop/python/filter dash/Item_file_1.xlsx')
df_item = pd.read_excel(
    'C:/Users/Pratik Kumar/Desktop/python/filter dash/Trade_file_1.xlsx')
...
sideBar = html.Div([
    html.Ul([
        html.A([
            html.Li([
                html.I([
                    html.Button(["Trade"], className="sideBarText",
                                value='Trade', id="aTrade")
                ], className="fa fa-home"),
            ], className="w3-large logoColor")
        ]),
        html.A([
            html.Li([
                html.I([
                    html.Button(["Category"], className="sideBarText",
                                value='Category', id="aCategory")
        ...
        html.A([
            html.Li([
                html.I([
                    html.Button(["Head"], className="sideBarText",
                                value='Head', id="aHead")
...
app.layout = html.Div([
    ...
    html.Div([
        ...
        html.Div([
            html.Div(
                [
                    ...
                    html.Div([
                        html.Span(
                            [html.Div([html.H5(children='Final date for Custom'), date_mtd3], style={'display': 'flex'})], className="categoriesFont")],
                        className="col"),
                    html.Div([
                        html.Span(
        ...
        html.H2(children="Consolidated Table followed by Graph",  style={'textAlign': 'center'}), html.Div([table_graph], className="table_graph"), fig_plot], className="container mainCont divContCenter")
])
